CreateVehicles()
{
	...
	CreateVehicle(488,-2055.2781,443.6082,139.7422,270.6632,1,16,600); // CNN maverick
	//=================================== TAXI =================================
    ...
    */
    ...
    //Taxi
	taxicar[46] = CreateVehicle(420,-1656.1839600,1314.0269775,6.8889999,133.9998779,6,1,600);
	taxicar[47] = CreateVehicle(420,-1652.9320068,1310.6180420,6.8829999,133.9947510,6,1,600);
	taxicar[48] = CreateVehicle(420,-1649.1479492,1306.8280029,6.8800001,133.9947510,6,1,600);
	taxicar[49] = CreateVehicle(420,-1645.5739746,1303.3649902,6.8800001,133.9947510,6,1,600);
	taxicar[50] = CreateVehicle(420,-1641.9200439,1299.7330322,6.8829999,133.9947510,6,1,600);
	taxicar[51] = CreateVehicle(420,-1638.4880371,1296.1199951,6.8889999,133.9947510,6,1,600);
	taxicar[52] = CreateVehicle(420,-2266.3059082,216.4299927,35.0139999,91.9947510,6,1,600);
	taxicar[53] = CreateVehicle(420,-2266.2829590,212.5310059,35.0139999,91.9940186,6,1,600);
	taxicar[54] = CreateVehicle(420,-2266.2858887,208.4400024,35.0139999,91.9940186,6,1,600);
	taxicar[55] = CreateVehicle(420,-2266.2260742,204.4470062,35.0139999,91.9940186,6,1,600);
	taxicar[56] = CreateVehicle(420,-2266.3479004,200.3609924,35.0139999,91.9940186,6,1,600);
	taxicar[57] = CreateVehicle(420,-2266.4819336,196.5110016,35.0139999,91.9940186,6,1,600);
	taxicar[58] = CreateVehicle(420,-2266.4938965,192.5180054,35.0139999,91.9940186,6,1,600);
	taxicar[59] = CreateVehicle(420,-2266.5119629,188.6130066,35.0139999,91.9940186,6,1,600);
	taxicar[60] = CreateVehicle(420,-2266.6550293,148.9179993,35.0139999,91.9940186,6,1,600);
	taxicar[61] = CreateVehicle(420,-2266.7849121,144.9859924,35.0139999,91.9940186,6,1,600);
	taxicar[62] = CreateVehicle(420,-2266.9040527,141.0339966,35.0070000,91.9940186,6,1,600);
	taxicar[63] = CreateVehicle(420,-2266.9980469,137.0959930,35.0219994,91.9940186,6,1,600);
	taxicar[64] = CreateVehicle(420,-2267.1789551,132.9909973,35.0219994,91.9940186,6,1,600);
	taxicar[65] = CreateVehicle(420,-2267.0778809,129.0749969,35.0219994,91.9940186,6,1,600);
	taxicar[66] = CreateVehicle(420,-2266.8840332,124.9879990,35.0219994,91.9940186,6,1,600);
	taxicar[67] = CreateVehicle(420,-2267.1750488,121.0329971,35.0219994,91.9940186,6,1,600);
	taxicar[68] = CreateVehicle(420,-2267.2661133,117.4410019,35.0219994,91.9940186,6,1,600);
	//===============================Taxi 5 lvl================================
    // taxi5lvl
	taxi5lvlcar[0] = CreateVehicle(405,2452.0928,1345.6039,10.7218,360.0000,6,6,600);
	taxi5lvlcar[1] = CreateVehicle(405,2455.2854,1345.6040,10.7222,359.9941,6,6,600);
	taxi5lvlcar[2] = CreateVehicle(405,2458.5432,1345.6029,10.7238,0.0000,6,6,600);
	taxi5lvlcar[3] = CreateVehicle(405,2461.7390,1345.6027,10.7255,360.0000,6,6,600);
	taxi5lvlcar[4] = CreateVehicle(405,2464.9668,1345.6021,10.7256,0.0000,6,6,600);
	taxi5lvlcar[5] = CreateVehicle(405,2466.0000,1336.7303,10.7267,180.0000,6,6,600);
	taxi5lvlcar[6] = CreateVehicle(405,2462.5000,1336.7303,10.7267,180.0000,6,6,600);
	taxi5lvlcar[7] = CreateVehicle(405,2459.0000,1336.7303,10.7319,180.0000,6,6,600);
	taxi5lvlcar[8] = CreateVehicle(405,2455.5000,1336.7303,10.7266,180.0000,6,6,600);
	taxi5lvlcar[9] = CreateVehicle(405,2452.0000,1336.7303,10.7266,180.0000,6,6,600);
	...
	//=============================== Taxi 10 lvl ================================
    // taxi10lvl
	taxi10lvlcar[0] = CreateVehicle(560,2471.3752,1357.9017,10.5389,180.0000,6,6,600);
	taxi10lvlcar[1] = CreateVehicle(560,2468.1721,1357.9017,10.5388,180.0000,6,6,600);
	taxi10lvlcar[2] = CreateVehicle(560,2464.8149,1357.9017,10.5388,180.0000,6,6,600);
	taxi10lvlcar[3] = CreateVehicle(560,2461.6885,1357.9019,10.5384,180.0000,6,6,600);
	taxi10lvlcar[4] = CreateVehicle(560,2458.4102,1357.9019,10.5385,180.0000,6,6,600);
	taxi10lvlcar[5] = CreateVehicle(560,2441.0618,1350.0000,10.5205,270.0000,6,6,600);
	taxi10lvlcar[6] = CreateVehicle(560,2441.0625,1346.5000,10.5388,270.0000,6,6,600);
	taxi10lvlcar[7] = CreateVehicle(560,2441.0625,1343.0000,10.5387,270.0000,6,6,600);
	taxi10lvlcar[8] = CreateVehicle(560,2441.0625,1339.5000,10.5387,270.0000,6,6,600);
	taxi10lvlcar[9] = CreateVehicle(560,2441.0625,1336.0000,10.5388,270.0000,6,6,600);
	taxi10lvlcar[10] = CreateVehicle(560,2441.0625,1332.5000,10.5388,270.0000,6,6,600);
	...
	//=============================== Taxi 40 lvl ================================
    // taxi40lvl
	taxi40lvlcar[0] = CreateVehicle(402,2454.3059,1327.0875,10.6575,359.5276,6,6,600);
	taxi40lvlcar[1] = CreateVehicle(402,2450.8796,1327.1024,10.6573,359.8735,6,6,600);
	taxi40lvlcar[2] = CreateVehicle(402,2447.7275,1326.9869,10.6573,2.1801,6,6,600);
	taxi40lvlcar[3] = CreateVehicle(402,2441.3601,1353.9213,10.6573,268.7980,6,6,600);
	taxi40lvlcar[4] = CreateVehicle(402,2441.2283,1357.5021,10.6573,269.9194,6,6,600);
	taxi40lvlcar[5] = CreateVehicle(402,2452.0759,1357.9415,10.6573,179.6138,6,6,600);
	taxi40lvlcar[6] = CreateVehicle(402,2455.2197,1357.8628,10.6573,180.7671,6,6,600);
	//============================== Rent VIP ==================================
    ...
    */
	...
	CreateVehicle(487,-2027.3175,-111.6481,39.0855,41.9733,79,79,600); // Licenzer Maverick 0
	//=================================== YAKUZA ===============================
